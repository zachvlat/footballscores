...
interface HockeyApi {
    ...
    @GET
    suspend fun getHockeyScores(@retrofit2.http.Url url: String): LiveScoresResponse
    
    companion object {
        private const val BASE_URL = "https://prod-cdn-mev-api.livescore.com/v1/api/app/date/hockey/"
